...
import 'package:botchat/services/bot.dart';
import 'package:botchat/services/chatbubble.dart';
        ...
        child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Row(
                children: [
                  CircleAvatar(
                    backgroundImage: AssetImage('/bot.png'),
                  ),
                  SizedBox(width: 15.0),
                  Text(
                    'SirBot',
            ...
            body: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage("/chatbg3.jpg"), fit: BoxFit.cover),
              ),
              child: Column(
                children: [
                  Container(
                      ...
                      children: [
                        Expanded(
                          child: TextFormField(
                            ...
                            cursorColor: Color.fromARGB(255, 67, 154, 158),
                            style: TextStyle(
                                fontSize: 25.0,
                                color: Colors.black,
                                fontFamily: 'PoorStory-Regular'),
